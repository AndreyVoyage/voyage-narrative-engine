...
export const ru = {
  ...
  "settings.textModelHint": "Используется для диалога с персонажем и соавтора.",
  ...
  "role.DIALOGUE": "Текстовая модель",
  ...
  "assistant.coauthor": "Соавтор",
  "assistant.compose": "Сочинить",
  "assistant.expand": "Развить",
  "assistant.working": "Соавтор пишет…",
  "assistant.restoreOriginal": "Вернуть исходный текст",
  "assistant.unavailable": "Настройте текстовую модель в настройках.",
