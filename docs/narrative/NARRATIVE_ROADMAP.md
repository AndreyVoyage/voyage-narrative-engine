...
```text
HEAD == origin/main == b53a0d1dca3e33cf1198ae0da3b2b866c8ea6a8f
...
- **Unlocks.** Проектирование scoped live/dev JSON контракта; будущий N5-Dev (in-place edit) только после него.
...
- **Blocked-by.** N2 (live runtime + write-back), N4 (UI-основа), N5F (scoped live/dev JSON path design).
...
```text
N0 ─▶ N1 ─▶ N2 ─▶ N3 ─▶ N4 ─▶ N5A ─▶ N5B ─▶ N5D ─▶ N5F ─▶ N5-Dev ─▶ N6
              │           ▲
...
N5-Dev (in-place edit) НЕВОЗМОЖЕН раньше N5F + scoped live/dev JSON contract.
