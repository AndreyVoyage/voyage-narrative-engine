...
> **КРАТКАЯ ВЕРСИЯ.** Полный алгоритм сборки, приоритеты конфликтов, примеры и спецификация ag_level — см. в `03_ASSEMBLY_GUIDE.md`.
...
- memory/emotional_anchors.json — НЛП-якоря (count/intensity)
...
---
*Сгенерировано автоматически по миграции KIRA_MODULE_v14.json → модульная архитектура v2.1*
